...
"CREATE TABLE Posts (postid INT AUTO_INCREMENT, added TIMESTAMP DEFAULT CURRENT_TIMESTAMP, name VARCHAR(100), url VARCHAR(255), owner VARCHAR(100), ip VARCHAR(15), colour VARCHAR(20) DEFAULT 'lavender', PRIMARY KEY(postid), FOREIGN KEY(owner) REFERENCES Users(name))",
